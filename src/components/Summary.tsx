...
export default function Summary() {
  ...
  return (
    <section id="summary" className="bg-section-alt py-20 md:py-24">
      <div className="max-w-6xl mx-auto px-6">
        <div ref={ref} className="section-reveal">

          <h2 className="text-3xl md:text-5xl font-bold text-primary mt-2 mb-6 md:mb-8 leading-tight">
            Get to <br className="hidden md:block" /> Know Me
          </h2>
          <div className="w-12 h-1 bg-accent-blue rounded mb-8 md:mb-10" />
          <div className="max-w-3xl">
            <p className="text-sm md:text-base text-foreground leading-7 md:leading-8 font-light">
            ...
            <p className="text-sm md:text-base text-foreground leading-7 md:leading-8 font-light mt-5">
